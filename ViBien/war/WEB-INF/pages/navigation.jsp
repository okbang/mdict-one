          ...
          <tr>
            ...
            <td>
              <TABLE border=0 cellSpacing=0 cellPadding=0>
                <TR>
                  ...
                  <TD class=uportal-background-med rowSpan=4 width=22><IMG alt="" src="pages/images/${nav_menu_active}_tab.gif" width=22 height=23></TD>
                </TR>
                <TR>
                  <TD class=uportal-background-${nav_menu_dark_med} height=20 vAlign=center noWrap><IMG alt="" src="pages/images/transparent.gif" width=10 height=10><A class=uportal-tab-text${nav_menu_selected} href="#" onclick='submitAction("frmNavigation","Navigation", "clickService")'>Thực đơn</A>
            ...
            <td>
              <TABLE border=0 cellSpacing=0 cellPadding=0>
                ...
                <TR>
                  <TD class=uportal-background-med height=20 vAlign=center noWrap><IMG alt="" src="pages/images/transparent.gif" width=10
                    height=10> <A class=uportal-tab-text href="#">Liên hệ</A><IMG alt="" src="pages/images/transparent.gif"
