@ECHO OFF
REM -------------------------------------------------------------------
REM Licensed to Open-Ones Group under one or more contributor license
...
REM Open-Ones Group licenses this file to you under the Apache License,
...
REM -------------------------------------------------------------------
ECHO Delete the temporary generated folders by compiling
ant clean