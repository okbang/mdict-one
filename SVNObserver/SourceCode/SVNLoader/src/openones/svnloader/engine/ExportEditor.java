...
public class ExportEditor implements ISVNEditor {
     ...
     * to process other files and directories inside this directory.
     * 
     * In case of export this method will never be called because we reported that our 'working copy' is empty and so
     * server knows that there are no 'existing' directories.
     */
    ...
    /*
     * Called when directory at 'path' should be somehow processed, but authenticated user (or anonymous user) doesn't
     * have enough access rights to get information on this directory (properties, children).
     */
    public void absentDir(String path) throws SVNException {
    }

    /*
     * Called when file at 'path' should be somehow processed, but authenticated user (or anonymous user) doesn't have
     * enough access rights to get information on this file (contents, properties).
     */
