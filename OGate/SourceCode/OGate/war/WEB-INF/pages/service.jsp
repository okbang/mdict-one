...
<TABLE FRAME=VOID CELLSPACING=0 COLS=6 RULES=NONE BORDER=0 height="739">
    ...
    <TBODY>
        ...
        <TR>
            ...
            <TD STYLE="border-top: 1px solid #000000" ALIGN=LEFT VALIGN=TOP height="3" width="28"></TD>
        ...
        <TR>
            ...
            <TD ALIGN=LEFT VALIGN=TOP colspan="5">Software development 
            Life-cycle (SDLC), CMMI</TD>
        </TR>
        <TR>
            <TD HEIGHT=19 ALIGN=RIGHT VALIGN=TOP width="26"><FONT FACE="Wingdings">Ø</FONT></TD>
            <TD ALIGN=LEFT VALIGN=TOP colspan="5">Create requirement, solution, 
            detailed design for software product</TD>
        </TR>
        <TR>
            <TD HEIGHT=19 ALIGN=RIGHT VALIGN=TOP width="26"><FONT FACE="Wingdings">Ø</FONT></TD>
            <TD ALIGN=LEFT VALIGN=TOP colspan="5">Perform code review, create 
            unit test case, write unit test code, perform unit test</TD>
        </TR>
        <TR>
            <TD HEIGHT=19 ALIGN=RIGHT VALIGN=TOP width="26"><FONT FACE="Wingdings">Ø</FONT></TD>
            <TD ALIGN=LEFT VALIGN=TOP colspan="5">Perform cause analysis for 
            improvement<BR></TD>
        </TR>
        <TR>
        ...
        <TR>
            <TD STYLE="border-top: 1px solid #000000" HEIGHT=53 ALIGN=LEFT VALIGN=TOP width="26"><BR></TD>
            <TD STYLE="border-top: 1px solid #000000" COLSPAN=5 ALIGN=LEFT VALIGN=TOP>
            After finished this course, trainee will gain experiences of a 
            professional programmer. The trainee is reminded and gained the 
            experience of software processes such as Waterfall, Spiral Models; 
            process improvement model such as CMMI.</TD>
            </TR>
        <TR>
            <TD STYLE="border-bottom: 1px solid #000000" HEIGHT=21 ALIGN=LEFT VALIGN=TOP colspan="6">
            Duration:
...
&nbsp;</B><table border="1" width="100%" id="table1" cellspacing="0" cellpadding="0" height="321">
        ...
        <TR>
            ...
            <TD ALIGN=LEFT colspan="5">- Have knowledge about Java Web 
            Application Programming: JSP, Servlet</TD>
        </TR>
        <TR>
            <TD HEIGHT=18 ALIGN=LEFT width="26"><BR></TD>
            <TD ALIGN=LEFT colspan="5">- Should have skills to develop a small 
        ...
        <TR>
            <TD HEIGHT=18 ALIGN=LEFT width="26"><BR></TD>
            <TD ALIGN=LEFT width="28"><BR></TD>
            <TD ALIGN=LEFT colspan="4">+ Hibernate</TD>
        </TR>
    </TBODY>
</TABLE>
<p>Contact:
