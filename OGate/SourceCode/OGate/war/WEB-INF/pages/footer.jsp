...
<table border="0" width="100%" cellspacing="0" cellpadding="0" background="pages/images/bgfooter.gif" title="The web site is deployed from source code at https://open-ones.googlecode.com/svn/trunk/OGate/SourceCode/OGate,revision 340.">
    <tr>
