...
va='lz_chat_mail_email,lz_chat_mail_company,email,domain,password,existingpw,newpw,confirmpw,lz_chat_login_email,lz_chat_login_company'.split(',') //Put the ID of the fields you DON'T want to let users type Vietnamese in, multiple fields allowed, separated by a comma (,)
