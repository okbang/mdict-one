          ...
          <tr>
            <td class=uportal-background-med noWrap align=left
              ...
              <TABLE border=0 cellSpacing=0 cellPadding=0>
                <TR>
                  <TD class=uportal-background-med noWrap><IMG
                    alt="" src="pages/images/transparent.gif" width=1
                    height=1>
                  </TD>
                  <TD class=uportal-background-dark rowSpan=4 width=22><IMG
                    alt="" src="pages/images/after_active_tab.gif"
                    width=22 height=23>
                  </TD>
                </TR>
                <TR>
                ...
                <TR>
                  <TD class=uportal-background-dark noWrap><IMG
                    alt="" src="pages/images/transparent.gif" width=1
                    height=1>
                  </TD>
                </TR>
