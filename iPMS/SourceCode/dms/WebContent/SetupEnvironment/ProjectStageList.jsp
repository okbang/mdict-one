...
<%
	...
	ProjectStageListBean beanProjectStageList = (ProjectStageListBean)request.getAttribute("beanProjectStageList");
%>
...
<div ><p><img border="0" src="Images/ProjectStageListing.gif" width="411" height="28"></p></div>
          ...
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="18%" align="left">
                <input type="button" value="AddNew" name="AddNewProjectStage" class="button" onClick='javascript:doAddNew()'></td>
            </tr>
          </table>
...
<!-- Preparing to update -->
          ...
          <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#000000">
            ...
            <%
                for (int i = 0; i<beanProjectStageList.getProjectStageList().getNumberOfRows(); i++)
                {
                    String strID = beanProjectStageList.getProjectStageList().getCell(i,0);
                    String strName = beanProjectStageList.getProjectStageList().getCell(i,1);
	  ...
	  <!-- ************************************  Form Code Here  ************************************ -->
		<p><input type="button" name="DeleteProjectStage" class="button" onClick='javascript:doDelete()' value="Delete"></p>
