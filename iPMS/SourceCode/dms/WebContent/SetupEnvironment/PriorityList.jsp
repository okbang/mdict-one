...
<%
	...
	PriorityListBean beanPriorityList = (PriorityListBean)request.getAttribute("beanPriorityList");
%>
<html>
...
function doAddNew()
{
	var form = document.frmPriorityList;
	...
	form.hidActionDetail.value = "AddPriority";
...
function doDelete()
{
	...
	form.hidAction.value = "SE";
	form.hidActionDetail.value = "DeletePriority";
	form.action = "DMSServlet";
	form.submit();
}
...
function doUpdate(id, name)
{
	...
	form.hidName.value = name;
  	...
  	form.hidAction.value = "SE";
	form.hidActionDetail.value = "UpdatePriority";
	form.action = "DMSServlet";
	form.submit();
}
...
<div ><p><img border="0" src="Images/PriorityListing.gif" width="411" height="28"></p></div>
...
<table border="0" width="100%">
  ...
  <!-- ************************************  Form Body  ************************************ -->
	<form method="post" action = "DMSServlet" name="frmPriorityList">
    	...
    	<input TYPE = "hidden" NAME = "hidAction" VALUE = "">
          ...
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
              ...
              <td width="18%" align="left"><input type="button" class="button" value="AddNew" name="AddNewPriority" onClick='javascript:doAddNew()'></td>
            </tr>
          </table>
<!-- Preparing to update -->
          ...
          <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#000000">
            ...
            <%
                for (int i = 0; i<beanPriorityList.getPriorityList().getNumberOfRows(); i++)
                {
                    String strID = beanPriorityList.getPriorityList().getCell(i,0);
                    String strName = beanPriorityList.getPriorityList().getCell(i,1);
	  ...
	  <!-- ************************************  Form Code Here  ************************************ -->
		<p><input type="button" class="button" name="DeletePriority"  onClick='javascript:doDelete()' value="Delete"></p>

</form>
</body>
</html>
<script language = "Javascript">
  frmPriorityList.txtID.focus();
</script>