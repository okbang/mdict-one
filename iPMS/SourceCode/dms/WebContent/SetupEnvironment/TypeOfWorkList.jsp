...
<%
	...
	TypeOfWorkListBean beanTypeOfWorkList = (TypeOfWorkListBean)request.getAttribute("beanTypeOfWorkList");
%>
...
function doAddNew()
{
	...
	form.hidActionDetail.value = "AddTypeOfWork";
...
function doDelete()
{
	...
	form.hidAction.value = "SE";
	form.hidActionDetail.value = "DeleteTypeOfWork";
	form.action = "DMSServlet";
	form.submit();
}
...
function doUpdate(id, name)
{
	...
	form.hidName.value = name;
  	...
  	form.hidAction.value = "SE";
	form.hidActionDetail.value = "UpdateTypeOfWork";
	form.action = "DMSServlet";
	form.submit();
}
...
<div ><p><img border="0" src="Images/TypeOfWorkListing.gif" width="411" height="28"></p></div>
...
<table border="0" width="100%">
  ...
  <!-- ************************************  Form Body  ************************************ -->
	<form method="post" action = "DMSServlet" name="frmTypeOfWorkList">
          ...
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="18%" align="left">
                <input type="button" value="AddNew" name="AddNewTypeOfWork" class="button" onClick='javascript:doAddNew()'></td>
            </tr>
          </table>
...
<!-- Preparing to update -->
          ...
          <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#000000">
            ...
            <%
                for (int i = 0; i<beanTypeOfWorkList.getTypeOfWorkList().getNumberOfRows(); i++)
                {
                    String strID = beanTypeOfWorkList.getTypeOfWorkList().getCell(i,0);
                    String strName = beanTypeOfWorkList.getTypeOfWorkList().getCell(i,1);
	  ...
	  <!-- ************************************  Form Code Here  ************************************ -->
		<p><input type="button" name="DeleteTypeOfWork" class="button" onClick='javascript:doDelete()' value="Delete"></p>

</form>
</body>
</html>
<script language = "Javascript">
  frmTypeOfWorkList.txtID.focus();
</script>