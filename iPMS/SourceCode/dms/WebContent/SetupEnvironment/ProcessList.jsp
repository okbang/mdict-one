...
<%
	...
	ProcessListBean beanProcessList = (ProcessListBean)request.getAttribute("beanProcessList");
%>
<html>
<head>
...
//	var form = document.frmProcessList;
//
//	var strID;
//	var strName;
...
//	form.hidActionDetail.value = "AddProcess";
...
//
//	form.hidAction.value = "SE";
//	form.hidActionDetail.value = "DeleteProcess";
//	form.action = "DMSServlet";
//	form.submit();
}
...
//
//	form.hidAction.value = "SE";
//	form.hidActionDetail.value = "UpdateProcess";
//	form.action = "DMSServlet";
//	form.submit();
}
...
<div><p><img border="0" src="Images/ProcessListing.gif" width="411" height="28"></p></div>
...
<table border="0" width="100%">
  ...
  <!-- ************************************  Form Body  ************************************ -->
	<form method="post" action = "DMSServlet" name="frmProcessList">
		...
		<p></p>
 		<table border="0" width="100%" cellspacing="0" cellpadding="0">
 			<tr>
               ...
               <td width="18%" align="left"><input type="button" class="button" value="AddNew" name="AddNewProcess" onClick='javascript:doAddNew()'></td>
             </tr>
          </table>
...
<!-- Preparing to update -->
          ...
          <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#000000">
            ...
            <%
                for (int i = 0; i<beanProcessList.getProcessList().getNumberOfRows(); i++)
                {
                    String strID = beanProcessList.getProcessList().getCell(i,0);
                    String strName = beanProcessList.getProcessList().getCell(i,1);
	  ...
	  <!-- ************************************  Form Code Here  ************************************ -->
		<p><input type="button" class="button" name="DeleteProcess" onClick='javascript:doDelete()' value="Delete"></p>
</form>
</body>
</html>
<script language = "Javascript">
  frmProcessList.txtID.focus();
</script>