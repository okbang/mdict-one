...
<%
	...
	DefectTypeListBean beanDefectTypeList = (DefectTypeListBean)request.getAttribute("beanDefectTypeList");
%>
...
function doAddNew()
{
	var form = document.frmTypeDefectList;
	...
	form.hidActionDetail.value = "AddDefectType";
...
function doDelete()
{
	...
	form.hidAction.value = "SE";
	form.hidActionDetail.value = "DeleteDefectType";
	form.action = "DMSServlet";
	form.submit();
}
...
function doUpdate(id, name)
{
	...
	form.hidName.value = name;
  	...
  	form.hidAction.value = "SE";
	form.hidActionDetail.value = "UpdateDefectType";
	form.action = "DMSServlet";
	form.submit();
}
...
<div ><p><img border="0" src="Images/TypeDefectListing.gif" width="411" height="28"></p></div>
...
<table border="0" width="100%">
  ...
  <!-- ************************************  Form Body  ************************************ -->
	<form method="post" action = "DMSServlet" name="frmTypeDefectList">
	  <!-- ************************************  Standard Screen Identification  ************************************ -->
		<input TYPE = "hidden" NAME = "hidActionDetail" VALUE = "">
    	<input TYPE = "hidden" NAME = "hidAction" VALUE = "">

	  <!-- ************************************  Form variables  ************************************ -->
          	  <input type="hidden" name="UpdateTypeDefect" value="<%=beanDefectTypeList.getUpdateDefectType()%>" >
       	  <!-- ************************************  Form Code Here  ************************************ -->
		...
		<p></p>
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
              ...
              <td width="18%" align="left"><input type="button" class="button" value="AddNew" name="AddNewTypeDefect" onClick='javascript:doAddNew()'></td>
            </tr>
          </table>
...
<!-- Preparing to update -->
          ...
          <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#000000">
            ...
            <%
                for (int i = 0; i<beanDefectTypeList.getDefectTypeList().getNumberOfRows(); i++)
                {
                      String strID = beanDefectTypeList.getDefectTypeList().getCell(i,0);
                      String strName = beanDefectTypeList.getDefectTypeList().getCell(i,1);
  	  ...
  	  <!-- ************************************  Form Code Here  ************************************ -->
		<p><input type="button" class="button" name="DeleteTypeDefect" onClick='javascript:doDelete()' value="Delete"></p>
	</form>
</body>
</html>
<script language = "Javascript">
  frmTypeDefectList.txtID.focus();
</script>