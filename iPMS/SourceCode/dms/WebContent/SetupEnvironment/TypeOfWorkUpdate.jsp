...
<%
	...
	TypeOfWorkUpdateBean beanTypeOfWorkUpdate = (TypeOfWorkUpdateBean)request.getAttribute("beanTypeOfWorkUpdate");
%>
...
function doSave()
{
	var form = document.frmTypeOfWorkUpdate;
	...
	form.hidActionDetail.value = "SaveUpdateTypeOfWork";
...
<div ><p><img border="0" src="Images/TypeOfWorkUpdate.gif" width="411" height="28"></p></div>
...
<table border="0" width="100%">
  ...
  <!-- ************************************  Form Body  ************************************ -->
	<form method="post" action = "DMSServlet" name="frmTypeOfWorkUpdate">
     ...
     <tr>
     	...
     	<table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#000000">
              ...
              <tr class="Row2">
                <td width="15%">&nbsp;<%=beanTypeOfWorkUpdate.getTypeOfWorkList().getCell(0,0)%>
                	<input type = "hidden" name = "hidID" value = "<%=beanTypeOfWorkUpdate.getTypeOfWorkList().getCell(0,0)%>"></td>
                <td width="50%"><input type="text"name = "txtName" value = "<%=beanTypeOfWorkUpdate.getTypeOfWorkList().getCell(0,1)%>"  style = "width:100%" maxLength="30"></td>
               </tr>
          </table>
          </td>
          <td width="15%"></td>
	  ...
	  <!-- ************************************  Form Code Here  ************************************ -->
		...
		<p align="center"><input type="button" name="UpdateTypeOfWork" class="Button" onClick='javascript:doSave()' value="Update">&nbsp;&nbsp;&nbsp;&nbsp;
