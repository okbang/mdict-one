...
<%
	...
	WorkProductListBean beanWorkProductList = (WorkProductListBean)request.getAttribute("beanWorkProductList");
%>
...
<head>
	...
	<!-- Html Form Title -->
	<title>WorkProduct List</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<link rel="StyleSheet" href="styles/DMSStyleSheet.css" type="text/css">
<SCRIPT language = "javascript">
function doAddNew()
{
	alert('This function is moved to RMS !');
	return;
	
//	var form = document.frmWorkProductList;
...
<div ><p><img border="0" src="Images/WorkProductListing.gif" width="411" height="28"></p></div>
...
<table border="0" width="100%">
  ...
  <!-- ************************************  Form Body  ************************************ -->
	<form method="post" action = "DMSServlet" name="frmWorkProductList">
		...
		<p></p>
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
 			<tr>
               ...
               <td width="34%"><input type="text" name="txtName" size="40" maxLength="50"></td>
               <td width="18%" align="left">
                 <input type="button" class="button" value="AddNew" name="AddNewWorkProduct" onClick='javascript:doAddNew()'></td>
             </tr>
...
<!-- Preparing to update -->
          ...
          <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#000000">
            ...
            <%
                for (int i = 0; i<beanWorkProductList.getWorkProductList().getNumberOfRows(); i++)
                {
                    String strID = beanWorkProductList.getWorkProductList().getCell(i,0);
                    String strName = beanWorkProductList.getWorkProductList().getCell(i,1);
	  ...
	  <!-- ************************************  Form Code Here  ************************************ -->
		<p><input type="button" class="button" name="DeleteWorkProduct" onClick='javascript:doDelete()' value="Delete"></p>

</form>
</body>
</html>
<script language = "Javascript">
  frmWorkProductList.txtID.focus();
</script>