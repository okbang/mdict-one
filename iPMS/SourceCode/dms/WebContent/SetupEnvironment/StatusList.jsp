...
<%
	...
	StatusListBean beanStatusList = (StatusListBean)request.getAttribute("beanStatusList");
%>
...
function doAddNew()
{
	var form = document.frmStatusList;
	...
	form.hidActionDetail.value = "AddStatus";
...
function doDelete()
{
	...
	form.hidAction.value = "SE";
	form.hidActionDetail.value = "DeleteStatus";
	form.action = "DMSServlet";
	form.submit();
}
...
function doUpdate(id, name)
{
	...
	form.hidName.value = name;
  	...
  	form.hidAction.value = "SE";
	form.hidActionDetail.value = "UpdateStatus";
	form.action = "DMSServlet";
	form.submit();
}
...
<div ><p><img border="0" src="Images/StatusListing.gif" width="411" height="28"></p></div>
...
<table border="0" width="100%">
  ...
  <!-- ************************************  Form Body  ************************************ -->
	<form method="post" action = "DMSServlet" name="frmStatusList">
          ...
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
              ...
              <td width="18%" align="left">
                <input type="button" class="button" value="AddNew" name="AddNewStatus" onClick='javascript:doAddNew()'></td>
            </tr>
          </table>
...
<!-- Preparing to update -->
          ...
          <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#000000">
            ...
            <%
                for (int i = 0; i<beanStatusList.getStatusList().getNumberOfRows(); i++)
                {
                    String strID = beanStatusList.getStatusList().getCell(i,0);
                    String strName = beanStatusList.getStatusList().getCell(i,1);
...
<!-- ************************************  Form Code Here  ************************************ -->
	<p><input type="button" class="button" name="DeleteStatus" onClick='javascript:doDelete()' value="Delete"></p>

</form>
</body>
</html>
<script language = "Javascript">
  frmStatusList.txtID.focus();
</script>