...
<%
	...
	QCActivityListBean beanQCActivityList = (QCActivityListBean)request.getAttribute("beanQCActivityList");
%>
...
function doAddNew()
{
	var form = document.frmQCActivityList;
	...
	form.hidActionDetail.value = "AddQCActivity";
...
function doDelete()
{
	...
	form.hidAction.value = "SE";
	form.hidActionDetail.value = "DeleteQCActivity";
	form.action = "DMSServlet";
	form.submit();
}
...
function doUpdate(id, name)
{
	...
	form.hidName.value = name;
  	...
  	form.hidAction.value = "SE";
	form.hidActionDetail.value = "UpdateQCActivity";
	form.action = "DMSServlet";
	form.submit();
}
...
<div ><p><img border="0" src="Images/QCActivityListing.gif" width="411" height="28"></p></div>
...
<table border="0" width="100%">
  ...
  <!-- ************************************  Form Body  ************************************ -->
	<form method="post" action = "DMSServlet" name="frmQCActivityList">
		...
		<p></p>
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
              ...
              <td width="18%" align="left"><input type="button" class="button" value="AddNew" name="AddNewQCActivity" onClick='javascript:doAddNew()'></td>
            </tr>
          </table>
<!-- Preparing to update -->
          ...
          <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#000000">
            ...
            <%
                for (int i = 0; i<beanQCActivityList.getQCActivityList().getNumberOfRows(); i++)
                {
                    String strID = beanQCActivityList.getQCActivityList().getCell(i,0);
                    String strName = beanQCActivityList.getQCActivityList().getCell(i,1);
...
<!-- ************************************  Form Code Here  ************************************ -->
	<p><input type="button" class="button" name="DeleteQCActivity" onClick='javascript:doDelete()' value="Delete"></p>

</form>
</body>
</html>
<script language = "Javascript">
  frmQCActivityList.txtID.focus();
</script>