...
<%
	...
	SeverityListBean beanSeverityList = (SeverityListBean)request.getAttribute("beanSeverityList");
%>
...
function doAddNew()
{
	var form = document.frmSeverityList;
	...
	form.hidActionDetail.value = "AddSeverity";
...
function doDelete()
{
	...
	form.hidAction.value = "SE";
	form.hidActionDetail.value = "DeleteSeverity";
	form.action = "DMSServlet";
	form.submit();
}
...
function doUpdate(id, name)
{
	...
	form.hidName.value = name;
  	...
  	form.hidAction.value = "SE";
	form.hidActionDetail.value = "UpdateSeverity";
	form.action = "DMSServlet";
	form.submit();
}
...
<div ><p><img border="0" src="Images/SeverityListing.gif" width="411" height="28"></p></div>
...
<table border="0" width="100%">
  ...
  <!-- ************************************  Form Body  ************************************ -->
	<form method="post" action = "DMSServlet" name="frmSeverityList">
		...
		<p></p>
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
 			<tr>
               ...
               <td width="18%" align="left"><input type="button" class="button" value="AddNew" name="AddNewSeverity" onClick='javascript:doAddNew()'></td>
             </tr>
          </table>
...
<!-- Preparing to update -->
          ...
          <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#000000">
            ...
            <%
                for (int i = 0; i<beanSeverityList.getSeverityList().getNumberOfRows(); i++)
                {
                    String strID = beanSeverityList.getSeverityList().getCell(i,0);
                    String strName = beanSeverityList.getSeverityList().getCell(i,1);
	  ...
	  <!-- ************************************  Form Code Here  ************************************ -->
		<p><input type="button" class="button" name="DeleteSeverity" onClick='javascript:doDelete()' value="Delete"></p>

</form>
</body>
</html>
<script language = "Javascript">
  frmSeverityList.txtID.focus();
</script>