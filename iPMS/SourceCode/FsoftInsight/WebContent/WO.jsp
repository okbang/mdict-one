...
<LINK rel="stylesheet" href="WO.css" type="text/css">
...
<table border=0 cellspacing=0 cellpadding=0 width=780 style='width:6.5in;
 ...
 <tr style='height:72.1pt'>
  ...
  <td width=700 style='width:500pt;padding:0in 5.4pt 0in 5.4pt;height:72.1pt'>
  	<p class=HeaderTitle align=right style='margin-left:0in;text-align:right'><%=languageChoose.getMessage("fi.jsp.WO.WorkOrder")%><o:p></o:p></p>
  </td>
 </tr>
</table>
...
<tr>
 ...
 <tr>
  ...
  mso-border-top-alt:solid windowtext .75pt;mso-border-left-alt:solid windowtext .75pt;
  background:transparent;padding:0in 5.4pt 0in 5.4pt'>
  <p class=bang><%=((CommonTools.formatDouble(dpTaskInfo.usl)=="N/A")? "": CommonTools.formatDouble(dpTaskInfo.usl))%></p>
  </td>
  <td width=100 style='width:67.6pt;border-top:none;border-left:none;
  border-bottom:solid windowtext .75pt;border-right:solid windowtext .75pt;
  mso-border-top-alt:solid windowtext .75pt;mso-border-left-alt:solid windowtext .75pt;
  ...
  mso-border-top-alt:solid windowtext .75pt;mso-border-left-alt:solid windowtext .75pt;
  background:transparent;padding:0in 5.4pt 0in 5.4pt'>
  <p class=Bang0> <%=((CommonTools.formatDouble(dpTaskInfo.lsl)=="N/A")? "": CommonTools.formatDouble(dpTaskInfo.lsl))%></p>
  </td>
  <td width=100 style='width:94.95pt;border-top:none;border-left:none;
  border-bottom:solid windowtext .75pt;border-right:solid windowtext .75pt;
  mso-border-top-alt:solid windowtext .75pt;mso-border-left-alt:solid windowtext .75pt;
...
<p class=CompanyName style='margin-top:6.0pt;margin-right:0in;margin-bottom:
0in;margin-left:27.35pt;margin-bottom:.0001pt;line-height:150%;tab-stops:.5in'>&nbsp;<o:p></o:p></p>

<br>
<p class="sectiontitle"><b>8. <%=languageChoose.getMessage("fi.jsp.WO.ChangesToTheWorkOrder")%></b>
</p>
<table border=1 cellspacing=0 cellpadding=0 width = "598" style='margin-left:5.4pt;border-collapse:collapse;
 border:none;mso-border-alt:solid black .5pt;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
 <tr>
  <td width=70 valign=top bgcolor = "#C0C0C0" style='border:solid windowtext .75pt;
  padding:0in 5.4pt 0in 5.4pt'>
  ...
  <td width=80 valign=top bgcolor = "#C0C0C0" style='border:solid windowtext .75pt;
  border-left:none;mso-border-left-alt:solid windowtext .75pt;padding:0in 5.4pt 0in 5.4pt'>
...
%>
	...
	<tr>
		...
		<p class="Bang"><%=info.item == null ? "N/A": ConvertString.breakString(info.item,10)%></td>
		<td style="border-left: medium none; border-right: 1.0pt solid windowtext; border-top: medium none; border-bottom: 1.0pt solid windowtext; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in">
		<p class="Bang"><%=action%></td>
		<td style="border-left: medium none; border-right: 1.0pt solid windowtext; border-top: medium none; border-bottom: 1.0pt solid windowtext; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in">
		<p class="Bang"><%=(info.changes == null||info.changes.equals(""))? "N/A":ConvertString.breakString(info.changes,11)%></td>
		<td style="border-left: medium none; border-right: 1.0pt solid windowtext; border-top: medium none; border-bottom: 1.0pt solid windowtext; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in">
		<p class="Bang"><%=(info.reason == null||info.reason.equals(""))? "N/A" :ConvertString.breakString(info.reason,11)%></td>
		<td style="border-left: medium none; border-right: 1.0pt solid windowtext; border-top: medium none; border-bottom: 1.0pt solid windowtext; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in">
...
<p class=MsoNormal> &lt; <%=languageChoose.getMessage("fi.jsp.WO.Briefdescriptionoftheprojec")%> &gt;</p>

<p class="sectiontitle"><b>10. Lessons/Practices</b></p>
<p class=MsoNormal>N/A</p>

<p class="sectiontitle"><b>11. <%=languageChoose.getMessage("fi.jsp.WO.RewardAndPenalty")%></b></p>
<p class=MsoNormal> &lt;<%=languageChoose.getMessage("fi.jsp.WO.Descriptionoftherewardandor")%>&gt; </p>
...
<div style='mso-element:endnote' id=edn1><p class=MsoEndnoteText><a style='mso-endnote-id:edn1' href="#_ednref1" name="_edn1" title="">
<span class=MsoEndnoteReference><span style='vertical-align:baseline;vertical-align:baseline'><sup>1</sup></span></span></a>
<%=languageChoose.getMessage("fi.jsp.WO.NoteNumber01")%>
</p>
</div>
...
<%=languageChoose.getMessage("fi.jsp.WO.NoteNumber03")%>
</p>
</div>
